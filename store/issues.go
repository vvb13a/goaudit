...
type Issue struct {
	...
	AuditID       string    `gorm:"column:audit_id;type:text;not null;index:idx_issues_audit_id;index:idx_issues_audit_metrics,priority:1;uniqueIndex:idx_issues_audit_url_check"`
	...
	Severity      string    `gorm:"column:severity;type:text;not null;index:idx_issues_audit_metrics,priority:2"`
	...
	Lifecycle     string    `gorm:"column:lifecycle;type:text;not null;default:'';index:idx_issues_audit_metrics,priority:3"`
